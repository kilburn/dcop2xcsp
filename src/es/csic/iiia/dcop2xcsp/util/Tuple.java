 ...
 */
package es.csic.iiia.dcop2xcsp.util;
 ...
 * 
*/
public class Tuple<A,B> implements Iterable<Object>, Serializable, Comparable<Tuple> {
    ...
    public Tuple(final A value0, final B value1) {
        super();
        this.valueArray = new Object[]{value0,value1};
    ...
    /**
     * <p> Get the value at a specific position in the tuple. This method has to
     * return object, so using it you will lose the type-safety you get with the
     * <tt>getValueX()</tt> methods. </p>
     *     
